...
var (
	...
	DataBindingDepClassInfoPath              = "prebuilts/kscope/current/data-binding/class-info"
	DataBindingDepArtifactsPath              = "prebuilts/kscope/current/data-binding/artifacts"
